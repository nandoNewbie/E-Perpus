        ...
        <aside class="fixed inset-y-0 left-0 z-50 w-64 bg-slate-900 text-slate-300 flex flex-col justify-between shrink-0 shadow-xl border-r border-slate-800 transition-transform duration-300 md:translate-x-0 md:static"
            ...
            <div>
                ...
                <nav class="p-4 space-y-1">
                    ...
                    <a href="{{ route('admin.books') }}" wire:navigate @click="sidebarOpen = false" class="flex items-center gap-3 px-4 py-3 text-sm font-semibold rounded-xl transition hover:bg-slate-800 hover:text-white">
                        <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 6.253v13m0-13C10.832 5.477 9.246 5 7.5 5S4.168 5.477 3 6.253v13C4.168 18.477 5.754 18 7.5 18s3.332.477 4.5 1.253m0-13C13.168 5.477 14.754 5 16.5 5c1.747 0 3.332.477 4.5 1.253v13C19.832 18.477 18.247 18 16.5 18c-1.746 0-3.332.477-4.5 1.253"></path></svg>
                        Manajemen Buku
                    </a>
                    <a href="{{ route('admin.users') }}" wire:navigate @click="sidebarOpen = false" class="flex items-center gap-3 px-4 py-3 text-sm font-semibold rounded-xl transition hover:bg-slate-800 hover:text-white">
                        <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 4.354a4 4 0 110 5.292M15 21H3v-1a6 6 0 0112 0v1zm0 0h6v-1a6 6 0 00-9-5.197M13 7a4 4 0 11-8 0 4 4 0 018 0z"></path></svg>
                        Manajemen Anggota
                    </a>
                    <a href="{{ route('admin.borrowings') }}" wire:navigate @click="sidebarOpen = false" class="flex items-center gap-3 px-4 py-3 text-sm font-semibold rounded-xl transition hover:bg-slate-800 hover:text-white">
                        <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M8 7V3m8 4V3m-9 8h10M5 21h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v12a2 2 0 002 2z"></path></svg>
                        Peminjaman Buku
                    </a>
                    <a href="{{ route('admin.returns') }}" wire:navigate @click="sidebarOpen = false" class="flex items-center gap-3 px-4 py-3 text-sm font-semibold rounded-xl transition hover:bg-slate-800 hover:text-white">
                        <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M8 7V3m8 4V3m-9 8h10M5 21h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v12a2 2 0 002 2z"></path></svg>
                        Pengembalian Buku
                    </a>
                </nav>
