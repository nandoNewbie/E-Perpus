            ...
            <div class="bg-slate-800 border border-slate-700 rounded-xl w-full max-w-md shadow-2xl transition-all">
                ...
                <form wire:submit.prevent="{{ $isEditMode ? 'update' : 'store' }}" class="p-6 space-y-4">
                    ...
                    <div>
                        ...
                        <input wire:model="email" type="email" class="w-full bg-slate-700 border border-slate-600 rounded-lg px-3 py-2 text-sm text-white focus:outline-none focus:border-indigo-500">
